...
// Funções de Clientes
// Normaliza o telefone para que o mesmo cliente seja encontrado
// independentemente de máscara, espaços, parênteses ou código do país.
...
export async function saveCustomerProfile(phone: string, data: any) {
  try {
    ...
    if (normalizedPhone.length < 10) {
      throw new Error('Telefone inválido para salvar o cadastro.');
    }
