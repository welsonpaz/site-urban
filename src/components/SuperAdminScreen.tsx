      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4 relative">
        {onBack && (
          <button
            type="button"
            onClick={onBack}
            className="absolute top-5 left-5 flex items-center gap-2 px-3 py-2 bg-gray-900 hover:bg-gray-800 border border-gray-700 rounded-lg text-sm text-gray-200 transition-colors shadow-lg"
            title="Voltar"
          >
